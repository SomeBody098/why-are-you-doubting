...
public class BoundsParam implements Param {
    ...
    public BoundsParam(float position_x_percent, float position_y_percent, float wight_percent, float height_percent) {
